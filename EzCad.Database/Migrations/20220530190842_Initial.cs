        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BanRecord_AspNetUsers_BannedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Identities_AspNetUsers_HostUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Logins_AspNetUsers_HostUserId",
                        column: x => x.HostUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    OffenderId = table.Column<string>(type: "text", nullable: false),
                    OfficerId = table.Column<string>(type: "text", nullable: false),
                    Offence = table.Column<string>(type: "character varying(125)", maxLength: 125, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CriminalRecords_Identities_OffenderId",
                        column: x => x.OffenderId,
                        principalTable: "Identities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriminalRecords_Identities_OfficerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToIdentityId = table.Column<string>(type: "text", nullable: false),
                    FromIdentityId = table.Column<string>(type: "text", nullable: false),
                    Increase = table.Column<bool>(type: "boolean", nullable: false),
                    HostIdentityId = table.Column<string>(type: "text", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Identities_HostIdentityId",
                        column: x => x.HostIdentityId,
                        principalTable: "Identities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Identities_HostIdentityId",
                        column: x => x.HostIdentityId,
                        principalTable: "Identities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BanRecord_BannedById",
                table: "BanRecord",
                column: "BannedById");

            migrationBuilder.CreateIndex(
                name: "IX_CriminalRecords_OffenderId",
                table: "CriminalRecords",
                column: "OffenderId");

            migrationBuilder.CreateIndex(
                name: "IX_CriminalRecords_OfficerId",
                table: "CriminalRecords",
                column: "OfficerId");

            migrationBuilder.CreateIndex(
                name: "IX_Identities_HostUserId",
                table: "Identities",
                column: "HostUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Logins_HostUserId",
                table: "Logins",
                column: "HostUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromIdentityId",
                table: "Transactions",
                column: "FromIdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_HostIdentityId",
                table: "Transactions",
                column: "HostIdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ToIdentityId",
                table: "Transactions",
                column: "ToIdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_HostIdentityId",
                table: "Vehicles",
                column: "HostIdentityId");
        }
